---
source_url: "https://vault-portal.thoughtmachine.net/vault-core/5-9/EN/api/experience_layer_api"
title: "Experience Layer API"
scraped_at: "2026-06-22T19:16:37.609Z"
images: 0
---
...
For an overview of the general features of the API, see [API intro](/vault-core/5-9/EN/api/overview/).
...
**Permission Scopes:** xpl:write, xpl.payees:write, xpl.payees:create
...
**Permission Scopes:** xpl:write, xpl.payees:write, xpl.payees:update
...
-   [Posting instruction batches](/vault-core/5-9/EN/api/core_api#Posting_instruction_batches) in the Core API
    
-   A [payee](/vault-core/5-9/EN/api/experience_layer_api#Payees) in the Experience Layer API
...
**Permission Scopes:** xpl:write, xpl.transactions:write, xpl.transactions:create
...
**Permission Scopes:** xpl:write, xpl.transactions:write, xpl.transactions:update
...
The Payee Streaming API is an event stream of creations and updates of [Payee](/vault-core/5-9/EN/api/experience_layer_api#payee) resources. API calls to create or update a payee will generate an event on this topic.
...
[SemVer](/vault-core/5-9/EN/api/experience_layer_api#common)
...
[xpl\_api.v1.Payee](/vault-core/5-9/EN/api/experience_layer_api#payee)
...
The Transaction Streaming API is an event stream of creations and updates of [Transaction](/vault-core/5-9/EN/api/experience_layer_api#transaction) resources. API calls to create or update a transaction will generate an event on this topic.
...
[xpl\_api.v1.Transaction](/vault-core/5-9/EN/api/experience_layer_api#transaction)
...
[PaymentUpdatedEvent](/vault-core/5-9/EN/api/payments_hub_api#payment_events)
...
## [](#contracts_transaction_bridge "Copy link to heading")Contracts Transaction Bridge

chat\_bubble

Contracts Transaction Bridge is deprecated as of Vault Core release 4.7, and will be removed no earlier than release 6.0.

### [](#overview_of_the_contracts_transactions_bridge "Copy link to heading")Overview of the Contracts Transactions Bridge

Some [Smart Contracts](/vault-core/5-9/EN/reference/contracts/) generate postings, which are emitted by the Postings API as [PostingInstructionBatchCreatedEvent](/vault-core/5-9/EN/api/core_api#postinginstructionbatchcreatedevent)s.

Provided your Vault instance uses the [Experience Layer API](/vault-core/5-9/EN/api/experience_layer_api), then the Contracts Transaction Bridge will automatically create related [Transactions](/vault-core/5-9/EN/api/experience_layer_api#transactions), if the contained `PostingInstructionBatch`es meet a set of defined criteria for the corresponding credit and/or debit.
...
In the case of `PostingInstructionBatch`es that meet the defined [criteria](/vault-core/5-9/EN/api/experience_layer_api#criteria_for_creation_of_transactions) the Contracts Transaction Bridge will call the Experience Layer’s Transaction service to create corresponding `Transaction`s for customer accounts.
