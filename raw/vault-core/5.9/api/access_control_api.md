---
source_url: "https://vault-portal.thoughtmachine.net/vault-core/5-9/EN/api/access_control_api"
title: "Access Control API"
scraped_at: "2026-06-22T19:16:29.011Z"
images: 0
---
...
**Permissions** are access control tags that can be assigned to [Roles](/vault-core/5-9/EN#Roles). Permissions can be used to allow users to view pages or interact with resources. For further information, see [policies](/vault-core/5-9/EN/api/workflows_api#Policies).
...
-   **Data permissions**: custom permissions that can be created by users and used with [policies](/vault-core/5-9/EN/api/workflows_api#Policies) to control access to resources. In the Operations Dashboard these are called Custom Permissions.
...
**Roles** are groups of one or more permissions. They are used to assign access rights to employees. [Permissions](/vault-core/5-9/EN#Permissions) are assigned to a Role to define the access granted to any employee with that Role.
...
**Permission Scopes:** access\_control:write, access\_control.roles:write, access\_control.roles:create
...
**Permission Scopes:** access\_control:write, access\_control.roles:write, access\_control.roles:update
...
**Permission Scopes:** access\_control:write, access\_control.role\_data\_permission\_assocs:write, access\_control.role\_data\_permission\_assocs:create
...
**Permission Scopes:** access\_control:write, access\_control.role\_vault\_permission\_assocs:write, access\_control.role\_vault\_permission\_assocs:create
