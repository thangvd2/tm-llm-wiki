---
source_url: "https://vault-portal.thoughtmachine.net/vault-core/5-9/EN/vault_core_overview/what_is_vault_core"
title: "What is Vault Core?"
scraped_at: "2026-06-22T19:12:54.617Z"
images: 2
---
...
Fund balances can be recorded in many dimensions (known as coordinates), including: Currency Denominations, Funds phase and Asset type (as explained in [Balances](/vault-core/5-9/EN/vault_core_overview/what_is_vault_core#balances)).
...
For more information, see [Accounts version 2](/vault-core/5-9/EN/reference/accounts/accounts_version_2/).
...
The [denomination](/vault-core/5-9/EN/vault_core_overview/what_is_vault_core#denominations) (currency) dimension is used to ensure that all accounts in Vault Core can be multi-currency (if desired). The other dimensions, such as [Asset classes](/vault-core/5-9/EN/vault_core_overview/what_is_vault_core#asset_classes), [Addresses](/vault-core/5-9/EN/vault_core_overview/what_is_vault_core#addresses) and [Phases](/vault-core/5-9/EN/vault_core_overview/what_is_vault_core#phases) are used to simplify the logic of the account when defining it in a Smart Contract.

For more information, see [Balances](/vault-core/5-9/EN/reference/balances/) and [Balances Core API](/vault-core/5-9/EN/api/core_api#Balances).
...
Postings Instructions can have a *[Type](/vault-core/5-9/EN/reference/postings#posting_instruction_types)* in order to give financial context and purpose to the funds movements.
...
For more information, see [Posting Instruction Batches](/vault-core/5-9/EN/api/core_api#PostingInstructionBatch).
...
Postings move funds between account balance addresses of the same dimensions (phases, denominations and asset classes), as explained in [Balances](/vault-core/5-9/EN/vault_core_overview/what_is_vault_core#balances). Vault Core includes built-in Posting Types to achieve these movements.
...
For a full description of Vault Core posting types, see [Posting Instruction Types](/vault-core/5-9/EN/reference/postings#posting_instruction_types).
...
For more information, see [Payment Devices](/vault-core/5-9/EN/api/core_api#payment_devices).

## [](#smart_contracts "Copy link to heading")Smart Contracts

Smart Contracts are the encapsulation of the business logic for a customer account; they are an embodiment of the terms and conditions of the account. They contain the logic to accept and reject postings (in the pre-posting [hook](/vault-core/5-9/EN/vault_core_overview/what_is_vault_core#hooks)), and at other key points in the account’s [lifecycle](/vault-core/5-9/EN/vault_core_overview/what_is_vault_core#lifecycle). For example, opening and closing the account.
...
For a comprehensive introduction to Smart Contracts, see [Smart contracts overview](/vault-core/5-9/EN/reference/contracts/contracts_api_4xx/).
...
For more information about Hooks in Smart contracts, see [Hooks](/vault-core/5-9/EN/reference/contracts/contracts_api_4xx/concepts#hooks).
...
For an example of scheduled events, see [Scheduled events and balance addresses](/vault-core/5-9/EN/tutorials/smart-contracts#exercise_five__scheduled_events_and_balance_addresses).

For more information, see [Scheduler](/vault-core/5-9/EN/reference/scheduler/).
...
Vault Core 5 introduces a Parameters API for improved management of Parameters. For more information, see [Parameters](/vault-core/5-9/EN/reference/parameters).
...
For a list of topics by event, see [Core Streaming API](/vault-core/5-9/EN/api/core_api#core_streaming_api) reference documentation.
