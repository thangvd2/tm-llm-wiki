---
source_url: "https://vault-portal.thoughtmachine.net/vault-core/5-9/EN/vault_release_information/performance_and_testing"
title: "Performance and testing"
scraped_at: "2026-06-22T19:13:19.258Z"
images: 0
---
...
Here are the reports for [AWS](/vault-core/5-9/EN/resources/performance_reports/vault_core_performance_report_aws.html), [Azure](/vault-core/5-9/EN/resources/performance_reports/vault_core_performance_report_azure.html) and [GCP](/vault-core/5-9/EN/resources/performance_reports/vault_core_performance_report_gcp.html).

chat\_bubble

Upon re-evaluation the following changes will be made to tests:

The performance test for the end of day balance reconciliation journey does not align to client usage of the LedgerBalances API resource and therefore is not a useful measure of performance of this journey. Therefore this test will be removed and no longer reported from 5.9.0.

The Standard Retail performance profile provides all the indicators that Daily and Monthly performance profiles are providing. Therefore, the tests on Daily and Monthly performance profiles will be removed and no longer reported from Vault Core 5.10.0.

The performance test for the Posting Migration API does not align with realistic migration use cases and provides no representative value for client programmes. Therefore, this test will be removed and no longer reported starting from Vault Core 5.10.0.
...
For information about the disaster recovery steps you should run in Vault Core after a database backup, see the [Vault Core Disaster Recovery Guide](/vault-core/5-9/EN/environment_and_installation/infrastructure_docs/vault_disaster_recovery#about_this_guide).
...
-   [Single database with a standalone Kafka cluster](/vault-core/5-9/EN/environment_and_installation/infrastructure_docs/tmcomponent_operator_user_guide/active_passive#vault_core_setup)
    
-   [Multiple databases with kafka-based derived database replication](/vault-core/5-9/EN/environment_and_installation/infrastructure_docs/tmcomponent_operator_user_guide/active_passive#kafka_based_derived_database_replication_mode)
...
Tests have been executed using realistic cloud hardware for banks of particular sizes based on a Standard Retail Blend bank profile. For further information on Standard Retail Blend, refer to the Bank profiles in the [performance report](/vault-core/5-9/EN/vault_release_information/performance_and_testing#the_performance_report) for your cloud service provider.
