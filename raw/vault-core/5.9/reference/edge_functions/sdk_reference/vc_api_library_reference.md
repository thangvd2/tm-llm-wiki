---
source_url: "https://vault-portal.thoughtmachine.net/vault-core/5-9/EN/reference/edge_functions/sdk_reference/vc_api_library_reference"
title: "Library reference: vc_api"
scraped_at: "2026-06-22T19:18:28.686Z"
images: 0
---
...
Note: This field has no effect on migrations to a product version on Contracts Language API version 4. See [Account conversions](/vault-core/5-9/EN/reference/accounts/accounts_version_1#account_conversions).
...
An adjustment applies to a fixed time period. The `timeline_start_timestamp` marks the start of the period and will either be the earliest value/effective time or the unix epoch depending on factors such as whether this is the first adjustment on the account or whether adjustments are being compounded.
...
Enum value indicating which [restriction type](/vault-core/5-9/EN/api/core_api#restriction_types) this applies to.
