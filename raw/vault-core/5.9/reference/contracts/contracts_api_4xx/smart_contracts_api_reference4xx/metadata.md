---
source_url: "https://vault-portal.thoughtmachine.net/vault-core/5-9/EN/reference/contracts/contracts_api_4xx/smart_contracts_api_reference4xx/metadata"
title: "Metadata"
scraped_at: "2026-06-22T19:17:30.314Z"
images: 0
---
...
An optional list of the Smart Contract [Event Types Groups](/vault-core/5-9/EN/reference/contracts/contracts_api_4xx/common_types_4xx/classes#eventtypesgroup). If defined, the `event_types` list is no longer optional. More details about Scheduler groups can be found [here](/vault-core/5-9/EN/reference/scheduler#schedule_groups).
...
An optional list of Smart Contract data fetchers.

The classes of the fetchers allowed in this list, defined using the pattern `[FetcherType]Fetcher`, can be found in [Classes](/vault-core/5-9/EN/reference/contracts/contracts_api_4xx/common_types_4xx/classes).

The fetcher IDs of the same [fetcher type](/vault-core/5-9/EN/reference/contracts/contracts_api_4xx/smart_contracts_api_reference4xx/account_fetcher_requirements) (postings, balances, etc) must be unique. If you’re using [sub\_account\_types](/vault-core/5-9/EN/reference/contracts/contracts_api_4xx/smart_contracts_api_reference4xx/metadata#sub_account_types), every fetcher ID must be unique across **all** data fetchers.

To request hook data based on these fetchers, you can define fetcher IDs in the `@fetch_account_data` [decorator](/vault-core/5-9/EN/reference/contracts/contracts_api_4xx/smart_contracts_api_reference4xx/account_fetcher_requirements) arguments. For more details about optimised data fetching, see [Optimised Data Fetching](/vault-core/5-9/EN/reference/contracts/contracts_api_4xx/concepts#data_fetchers) and [Smart Contract Data Requirements](/vault-core/5-9/EN/reference/contracts/contracts_api_4xx/performance_considerations#smart_contract_data_requirements).
...
An optional list of the Smart Contract, used to validate the notification type parameter in the [AccountNotificationDirective](/vault-core/5-9/EN/reference/contracts/contracts_api_4xx/common_types_4xx/classes#accountnotificationdirective).
...
The adjustment strategy to use. The supported options are listed in [AdjustmentStrategy](/vault-core/5-9/EN/reference/contracts/contracts_api_4xx/common_types_4xx/enums#adjustmentstrategy).
