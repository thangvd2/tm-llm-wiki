---
source_url: "https://vault-portal.thoughtmachine.net/vault-core/5-9/EN/reference/contracts/contracts_api_4xx/smart_contracts_api_reference4xx/vault"
title: "Account Vault Object"
scraped_at: "2026-06-22T19:17:37.032Z"
images: 0
---

# Account Vault Object
...
`ZoneInfo` The timezone in which this Account operates. If the account **belongs to a [Processing Group](/vault-core/5-9/EN/reference/processing_groups)** which has a timezone declared, this will be the timezone used. If there is **no Processing Group timezone set**, the `events_timezone` [metadata](/vault-core/5-9/EN/reference/contracts/contracts_api_4xx/smart_contracts_api_reference4xx/metadata#events_timezone) in the Contract will be used. If **neither of these is set**, the timezone defaults to UTC.

### [](#tside "Copy link to heading")tside

`Tside` The treasury side of the Account. It determines the Account [Balance](/vault-core/5-9/EN/reference/contracts/contracts_api_4xx/common_types_4xx/classes#balance) net sign.
...
**Note**: If the Account was migrated using the [Data Loader](/vault-core/5-9/EN/environment_and_installation/migrating_to_vault/migrating_using_the_data_loader_api), this is the date the account was created in the legacy core, not when it was migrated and inserted into Vault Core.
...
Returns the alias value set for the Smart Contract Version in the Supervisor [SmartContractDescriptor](/vault-core/5-9/EN/reference/contracts/contracts_api_4xx/common_types_4xx/classes#smartcontractdescriptor) object. Available in Supervisor Contract code for use on the Supervisee’s [Vault](/vault-core/5-9/EN/reference/contracts/contracts_api_4xx/smart_contracts_api_reference4xx/vault) object only. If no aliases are defined in the Supervisor Contract metadata, then 'None' is returned. It cannot be used on a non-supervised Vault object.
...
Returns the [BalancesObservation](/vault-core/5-9/EN/reference/contracts/contracts_api_4xx/common_types_4xx/classes#balancesobservation) at the datetime defined by the [BalancesObservationFetcher](/vault-core/5-9/EN/reference/contracts/contracts_api_4xx/common_types_4xx/classes#balancesobservationfetcher) whose id is provided in the [balances](./account_fetcher_requirements#balances) argument of the `@fetch_account_data` decorator.
...
Returns a [CalendarEvents](/vault-core/5-9/EN/reference/contracts/contracts_api_4xx/common_types_4xx/classes#calendarevents) object with the chronologically ordered list of [CalendarEvent](/vault-core/5-9/EN/reference/contracts/contracts_api_4xx/common_types_4xx/classes#calendarevent) that exist in the Vault calendars with the given `calendar_ids`. These `calendar_ids` have to be requested using the hook '@requires' decorator. For information about the time range of events returned, see [calendar](/vault-core/5-9/EN/reference/contracts/contracts_api_4xx/smart_contracts_api_reference4xx/hook_requirements#calendar)
...
The chronologically ordered list of [CalendarEvent](/vault-core/5-9/EN/reference/contracts/contracts_api_4xx/common_types_4xx/classes#calendarevent) objects.
...
The id of the [CalendarsObservationFetcher](/vault-core/5-9/EN/reference/contracts/contracts_api_4xx/common_types_4xx/classes#calendarsobservationfetcher).
...
Returns the [CalendarTimeseries](/vault-core/5-9/EN/reference/contracts/contracts_api_4xx/common_types_4xx/classes#calendartimeseries) for the interval defined by the [CalendarsIntervalFetcher](/vault-core/5-9/EN/reference/contracts/contracts_api_4xx/common_types_4xx/classes#calendarsintervalfetcher) whose id is provided in the [calendars](./account_fetcher_requirements#calendars) argument of the `@fetch_account_data` decorator.
...
The id of the [CalendarsIntervalFetcher](/vault-core/5-9/EN/reference/contracts/contracts_api_4xx/common_types_4xx/classes#calendarsintervalfetcher).
...
Returns the [FlagsObservation](/vault-core/5-9/EN/reference/contracts/contracts_api_4xx/common_types_4xx/classes#flagsobservation) at the datetime defined by the [FlagsObservationFetcher](/vault-core/5-9/EN/reference/contracts/contracts_api_4xx/common_types_4xx/classes#flagsobservationfetcher) whose id is provided in the [flags](./account_fetcher_requirements#flags) argument of the `@fetch_account_data` decorator.
...
The id of the [FlagsObservationFetcher](/vault-core/5-9/EN/reference/contracts/contracts_api_4xx/common_types_4xx/classes#flagsobservationfetcher).

 |

**Return Value:** `FlagsObservation`

The observation which includes the flag values and the datetime at which the values apply. The flags attribute of the [FlagsObservation](/vault-core/5-9/EN/reference/contracts/contracts_api_4xx/common_types_4xx/classes#flagsobservation) has type defaultdict if the [FlagsObservationFetcher](/vault-core/5-9/EN/reference/contracts/contracts_api_4xx/common_types_4xx/classes#flagsobservationfetcher) did not specify a [FlagsFilter](/vault-core/5-9/EN/reference/contracts/contracts_api_4xx/common_types_4xx/classes#flagsfilter). Otherwise, the flags attribute has type dict, containing an entry for each of the flag definition ids specified in the [FlagsFilter](/vault-core/5-9/EN/reference/contracts/contracts_api_4xx/common_types_4xx/classes#flagsfilter).
...
Returns the [FlagValueTimeseries](/vault-core/5-9/EN/reference/contracts/contracts_api_4xx/common_types_4xx/classes#flagvaluetimeseries) at the datetime defined by the [FlagsIntervalFetcher](/vault-core/5-9/EN/reference/contracts/contracts_api_4xx/common_types_4xx/classes#flagsintervalfetcher) whose id is provided in the [flags](./account_fetcher_requirements#flags) argument of the `@fetch_account_data` decorator.
...
The id of the [FlagsIntervalFetcher](/vault-core/5-9/EN/reference/contracts/contracts_api_4xx/common_types_4xx/classes#flagsintervalfetcher). If the provided fetcher\_id is not defined in the @fetch\_account\_data decorator, an `InvalidSmartContractError` will be raised.

 |

**Return Value:** `Union`\[`dict`\[`str`, `FlagValueTimeseries`\], `defaultdict`\[`str`, `FlagValueTimeseries`\]\]

A dictionary mapping the flag definition ids to the FlagValueTimeseries. The dictionary has type defaultdict if the [FlagsIntervalFetcher](/vault-core/5-9/EN/reference/contracts/contracts_api_4xx/common_types_4xx/classes#flagsintervalfetcher) did not specify a [FlagsFilter](/vault-core/5-9/EN/reference/contracts/contracts_api_4xx/common_types_4xx/classes#flagsfilter). Otherwise, the dictionary has type dict, containing an entry for each of the flag definition ids specified in the [FlagsFilter](/vault-core/5-9/EN/reference/contracts/contracts_api_4xx/common_types_4xx/classes#flagsfilter). In either case, the default value stored in the dictionary is a [FlagValueTimeseries](/vault-core/5-9/EN/reference/contracts/contracts_api_4xx/common_types_4xx/classes#flagvaluetimeseries) containing a [TimeseriesItem](/vault-core/5-9/EN/reference/contracts/contracts_api_4xx/common_types_4xx/classes#timeseriesitem) with value False effective from the start time defined in the fetcher.
...
Returns an enum that indicates which hook is currently being executed. See the list of possible values [here](/vault-core/5-9/EN/reference/contracts/contracts_api_4xx/common_types_4xx/enums#hookname).
...
Returns the effective timestamp of the last successful scheduled event hook execution for the given `event_type`.
...
The last `effective_datetime` of the last successful execution of [scheduled\_event\_hook](/vault-core/5-9/EN/reference/contracts/contracts_api_4xx/smart_contracts_api_reference4xx/hooks#scheduled_event_hook) as a timezone-aware UTC datetime.
...
Returns the [LastScheduledEventDateTimesObservation](/vault-core/5-9/EN/reference/contracts/contracts_api_4xx/common_types_4xx/classes#lastscheduledeventdatetimesobservation) at the datetime defined by the [LastScheduledEventDateTimesObservationFetcher](/vault-core/5-9/EN/reference/contracts/contracts_api_4xx/common_types_4xx/classes#lastscheduledeventdatetimesobservation) whose id is provided in the [last\_scheduled\_event\_datetimes](./account_fetcher_requirements#last_scheduled_event_datetimes) argument of the `@fetch_account_data` decorator.
...
The name of the [Parameter](/vault-core/5-9/EN/reference/contracts/contracts_api_4xx/common_types_4xx/classes#parameter). One of `name` or `fetcher_id` must be provided.
...
The id of the [ParametersObservationFetcher](/vault-core/5-9/EN/reference/contracts/contracts_api_4xx/common_types_4xx/classes#parametersobservationfetcher).
...
Gets a list of posting instruction objects, whose `value_datetime` fall within the requested time window, and their covering posting instructions. Sorted ascending by priority: `value_datetime`, `insertion_datetime`, then `booking_datetime`. You may order/filter further using the sorted builtin and other builtin mechanisms.
...
**When called in a Smart Contract hook using `@fetch_account_data` decorator**, only the posting instructions that fall into the requested time range and their covering posting instructions are returned. A `fetcher_id` must be specified in the [postings](./account_fetcher_requirements#postings) argument of the `@fetch_account_data` decorator and passed as an argument in the `get_posting_instructions` function call. The time window must be specified in the definition of the [PostingsIntervalFetcher](/vault-core/5-9/EN/reference/contracts/contracts_api_4xx/common_types_4xx/classes#postingsintervalfetcher) with the specified `fetcher_id` in the [data\_fetchers](./../smart_contracts_api_reference4xx/metadata#data_fetchers) list of the Contract metadata.
