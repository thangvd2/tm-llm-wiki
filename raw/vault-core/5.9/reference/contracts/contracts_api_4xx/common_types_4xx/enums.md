---
source_url: "https://vault-portal.thoughtmachine.net/vault-core/5-9/EN/reference/contracts/contracts_api_4xx/common_types_4xx/enums"
title: "Enumerations"
scraped_at: "2026-06-22T19:17:23.849Z"
images: 0
---
...
Specifies the adjustment strategy to use. `SCHEDULE_TRIGGERED` indicates that the adjustment process will be tied to one or more schedules. The adjustment process will run before a scheduled event is executed. If the `SCHEDULE_TRIGGERED` strategy is specified, then there must be at least one [SmartContractEventType](/vault-core/5-9/EN/reference/contracts/contracts_api_4xx/common_types_4xx/classes#smartcontracteventtype) defined in the [event\_types](/vault-core/5-9/EN/reference/contracts/contracts_api_4xx/smart_contracts_api_reference4xx/metadata#event_types) metadata with `adjustment_point = True`.
...
Describes reasons that a PostingInstruction can be rejected by Vault. The Restriction enums map to the RestrictionTypes on the Core API [Restriction Resource](/vault-core/5-9/EN/api/core_api#Restrictions). INSUFFICIENT\_FUNDS, AGAINST\_TERMS\_AND\_CONDITIONS, WRONG\_DENOMINATION and CLIENT\_CUSTOM\_REASON map to the corresponding Contracts [RejectionReason](/vault-core/5-9/EN/reference/contracts/contracts_api_4xx/common_types_4xx/enums#rejectionreason) enum.
...
May optionally be used as the `reason_code` parameter on the [Rejection](/vault-core/5-9/EN/reference/contracts/contracts_api_4xx/common_types_4xx/classes#rejection) class.
...
Account treasury side - determine account [Balance](/vault-core/5-9/EN/reference/contracts/contracts_api_4xx/common_types_4xx/classes#balance) net sign.
