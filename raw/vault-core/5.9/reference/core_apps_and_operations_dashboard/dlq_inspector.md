---
source_url: "https://vault-portal.thoughtmachine.net/vault-core/5-9/EN/reference/core_apps_and_operations_dashboard/dlq_inspector"
title: "DLQ Inspector"
scraped_at: "2026-06-22T19:19:21.373Z"
images: 2
---
...
To learn more about Dead Letter Queues, refer to the [Dead Letter Queues in Vault Core reference documentation](/vault-core/5-9/EN/reference/dlq).
...
DLQ Inspector allows for clients to set up auth via OIDC in place of SAML. For more information, see [Setting up and configuring OIDC authentication](/vault-core/5-9/EN/environment_and_installation/infrastructure_docs/setting_up_and_configuring_oidc_authentication).

In order to view the DLQ Inspector app, you must apply permissions to the Role used to login. For information about granting permissions for DLQ Inspector, see [Permissions](/vault-core/5-9/EN/reference/core_apps_and_operations_dashboard/dlq_inspector#permissions).
...
![DLQ republishing](_assets/dlq_republishing.kHHSB4BU_ml4vl_vaultcor.svg)
