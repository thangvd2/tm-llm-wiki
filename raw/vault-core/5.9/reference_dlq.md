---
source_url: "https://vault-portal.thoughtmachine.net/vault-core/5-9/EN/reference/dlq"
title: "Dead Letter Queues"
scraped_at: "2026-06-17T05:03:07.139Z"
images: 0
---
...
When a message appears on a DLQ, this indicates that the standard processing of the message was not able to complete, and no further processing of the message will occur automatically. You must take additional steps in order to recover the original operation that was unable to complete. Failure to do so can lead to incomplete Vault Core functionality. See [DLQ Inspector](/vault-core/5-9/EN/reference/core_apps_and_operations_dashboard/dlq_inspector) for more.
...
For more information on how to configure Alert Pagers, as well as the full list of DLQ alerts, see [Using the Observability Stack](/vault-core/5-9/EN/environment_and_installation/infrastructure_docs/observability_and_monitoring/using_the_observability_stack).
