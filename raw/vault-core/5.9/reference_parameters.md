---
source_url: "https://vault-portal.thoughtmachine.net/vault-core/5-9/EN/reference/parameters"
title: "Parameters"
scraped_at: "2026-06-17T05:03:09.161Z"
images: 2
---
...
-   For backwards compatibility, you can continue to use global and instance Parameters (with the `global_parameters` and `parameters` syntax respectively) until you are ready to [switch to the Core API Parameters resource](/vault-core/5-9/EN/reference/parameters/switching_to_core_api_parameters)
...
![param\_overview.svg](_assets/param_overview.DIX0OwLY_Z1EfmtF_vaultcor.webp)
...
](/vault-core/5-9/EN/reference/parameters/switching_to_core_api_parameters)
...
](/vault-core/5-9/EN/reference/parameters/building_and_managing_the_parameter_value_hierarchy)
...
](/vault-core/5-9/EN/reference/parameters/using_core_api_parameters)