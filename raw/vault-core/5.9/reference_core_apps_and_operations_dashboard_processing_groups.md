---
source_url: "https://vault-portal.thoughtmachine.net/vault-core/5-9/EN/reference/core_apps_and_operations_dashboard/processing_groups"
title: "Vault Processing Groups"
scraped_at: "2026-06-17T05:03:51.035Z"
images: 0
---
...
To learn more about Processing Groups, see [Processing Groups](/vault-core/5-9/EN/reference/processing_groups).
...
`Vault Version: View` is a required permission for all roles for access to the Processing Groups App.
...
core.accounts:read, core.internal\_accounts:read
...
core.accounts:create, core.internal\_accounts:create
...
Vault Processing Groups assumes familiarity with the Vault Core concept of [Processing Groups](/vault-core/5-9/EN/reference/processing_groups).
...
Pause and resume impacts schedules by following [Using a Processing Group for pausing/unpausing](/vault-core/5-9/EN/reference/processing_groups#using_a_processing_group_for_pausingunpausing).
