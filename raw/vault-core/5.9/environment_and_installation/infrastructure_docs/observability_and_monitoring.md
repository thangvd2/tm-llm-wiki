---
source_url: "https://vault-portal.thoughtmachine.net/vault-core/5-9/EN/environment_and_installation/infrastructure_docs/observability_and_monitoring"
title: "Observability and monitoring"
scraped_at: "2026-06-22T19:14:02.079Z"
images: 0
---
...
The Observability Stack is a [required component](/vault-core/5-9/EN/environment_and_installation/infrastructure_docs/getting_started_with_vault_core/requirements#required_components). Before installing Vault Core, you must first install the Observability Stack along with other required components. Use the `vaultctl install` command to ensure the Observability Stack is installed first.
...
](/vault-core/5-9/EN/environment_and_installation/infrastructure_docs/observability_and_monitoring/setting_up_the_observability_stack)
...
](/vault-core/5-9/EN/environment_and_installation/infrastructure_docs/observability_and_monitoring/using_the_observability_stack)
...
](/vault-core/5-9/EN/environment_and_installation/infrastructure_docs/observability_and_monitoring/multi_instance_monitoring)
...
](/vault-core/5-9/EN/environment_and_installation/infrastructure_docs/observability_and_monitoring/alerts)