---
source_url: "https://vault-portal.thoughtmachine.net/vault-core/5-9/EN/environment_and_installation/infrastructure_docs/advanced_deployment_modes"
title: "Advanced deployment modes"
scraped_at: "2026-06-22T19:15:29.938Z"
images: 0
---
...
The two patterns appear similar and their implementation is similar, but they cater for very different use cases and have subtle but important differences that you should consider.
...
[Read more about Blue-Green mode here](/vault-core/5-9/EN/environment_and_installation/infrastructure_docs/tmcomponent_operator_user_guide/blue_green)
...
[Read more about Active-Passive mode here](/vault-core/5-9/EN/environment_and_installation/infrastructure_docs/tmcomponent_operator_user_guide/active_passive)
...
[Read more about using multiple physical databases here](/vault-core/5-9/EN/environment_and_installation/infrastructure_docs/advanced_deployment_modes/multiple_physical_databases)
...
](/vault-core/5-9/EN/environment_and_installation/infrastructure_docs/advanced_deployment_modes/multiple_physical_databases)

chat\_bubble

Sharing secrets

Shared secrets access is relevant for both [Blue-Green](/vault-core/5-9/EN/environment_and_installation/infrastructure_docs/tmcomponent_operator_user_guide/blue_green) and [Active-Passive](/vault-core/5-9/EN/environment_and_installation/infrastructure_docs/tmcomponent_operator_user_guide/active_passive) advanced deployment modes.

In order for both the target and source clusters to access the shared/replicated resources they must have access to the same set of secrets. [Read more about sharing secrets here](/vault-core/5-9/EN/environment_and_installation/infrastructure_docs/tmcomponent_operator_user_guide/shared_secrets_access).