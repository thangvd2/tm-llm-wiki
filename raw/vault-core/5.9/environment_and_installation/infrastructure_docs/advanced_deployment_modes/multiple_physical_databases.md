---
source_url: "https://vault-portal.thoughtmachine.net/vault-core/5-9/EN/environment_and_installation/infrastructure_docs/advanced_deployment_modes/multiple_physical_databases"
title: "Using multiple physical databases"
scraped_at: "2026-06-22T19:15:31.762Z"
images: 1
---
...
You can find information about setting up multiple physical databases for Vault Core in the [Configuring multiple databases](/vault-core/5-9/EN/environment_and_installation/infrastructure_docs/vault_cloud_infrastructure/configuring_multiple_databases).
...
This mode requires Kafka replication between the active and passive environments; consult the [Active Passive: Considerations for standalone Kafka versus replicated Kafka](/vault-core/5-9/EN/environment_and_installation/infrastructure_docs/tmcomponent_operator_user_guide/active_passive#considerations_for_standalone_kafka_versus_replicated_kafka) section for more information on the implications of this configuration.

See: [Active Passive: Multiple database environments using the kafka-based derived database replication mode](/vault-core/5-9/EN/environment_and_installation/infrastructure_docs/tmcomponent_operator_user_guide/active_passive#multiple_database_environments_using_the_kafka_based_derived_database_replication_mode)
...
You should read these notes in conjunction with the instructions in the [Vault Disaster Recovery](/vault-core/5-9/EN/environment_and_installation/infrastructure_docs/vault_disaster_recovery) guidance.

Thought Machine strongly recommends that you take action to avoid a situation, as outlined in [Background to the disaster recovery process for Vault Core with multiple physical databases](/vault-core/5-9/EN/environment_and_installation/infrastructure_docs/advanced_deployment_modes/multiple_physical_databases#background_to_the_disaster_recovery_process_for_vault_core_with_multiple_physical_databases), whereby data stored in the warm database does not accurately reflect the records stored in the primary databases.
...
You should factor in these points for the Active-Passive [database failover action](/vault-core/5-9/EN/environment_and_installation/infrastructure_docs/tmcomponent_operator_user_guide/active_passive#3_database_failover).
...
You should continue to follow the existing [Disaster Recovery Operator](/vault-core/5-9/EN/environment_and_installation/infrastructure_docs/vault_disaster_recovery#disaster_recovery_operator_instructions) process, and rehydrate Core Kafka topics.
...
The timestamps are assigned using the `vaultctl dr rehydrate` command - see: [Disaster Recovery Operator](/vault-core/5-9/EN/environment_and_installation/infrastructure_docs/vault_disaster_recovery#disaster_recovery_operator_instructions)