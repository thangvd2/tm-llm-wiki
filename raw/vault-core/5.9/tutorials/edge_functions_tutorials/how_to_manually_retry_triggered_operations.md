---
source_url: "https://vault-portal.thoughtmachine.net/vault-core/5-9/EN/tutorials/edge_functions_tutorials/how_to_manually_retry_triggered_operations"
title: "How to manually bulk retry Edge Function Trigger Operations"
scraped_at: "2026-06-22T19:19:49.806Z"
images: 0
---
...
Edge Function Trigger Operations can sometimes enter a `FAILED` or `FAILED_TRANSIENT` state due to various reasons. Vault Core provides a mechanism to manually request a retry for these operations multiple times, by calling the [BulkRetryEdgeFunctionTriggerOperations](/vault-core/5-9/EN/api/edge_functions_api#_edge_functions_api_v1_BulkRetryEdgeFunctionTriggerOperationsResponse_BulkRetryEdgeFunctionTriggerOperations) endpoint.
...
2.  **Operation ID**: You need the unique identifier (`id`) of the Trigger Operation to be retried. Use the [ListEdgeFunctionTriggerOperations](/vault-core/5-9/EN/api/edge_functions_api#_edge_functions_api_v1_ListEdgeFunctionTriggerOperationsResponse_ListEdgeFunctionTriggerOperations) endpoint to fetch its `id`.
...
1.  Submitting a search query to the [ListEdgeFunctionTriggerOperations](/vault-core/5-9/EN/api/edge_functions_api#_edge_functions_api_v1_ListEdgeFunctionTriggerOperationsResponse_ListEdgeFunctionTriggerOperations) endpoint, and using a search filter on the `status` field to find `FAILED` or `FAILED_TRANSIENT` status operations.
...
Make an HTTP POST request to the following [BulkRetryEdgeFunctionTriggerOperations](/vault-core/5-9/EN/api/edge_functions_api#_edge_functions_api_v1_BulkRetryEdgeFunctionTriggerOperationsResponse_BulkRetryEdgeFunctionTriggerOperations) endpoint:
...
6.  A [public streaming execution API event](/vault-core/5-9/EN/api/edge_functions_api/edge_functions_streaming_api#edgefunctionexecutionevent) happens post-execution.
