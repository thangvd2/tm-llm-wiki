---
source_url: "https://vault-portal.thoughtmachine.net/vault-core/5-9/EN/product_library/product_specifications/credit_card/features"
title: "Product features"
scraped_at: "2026-06-22T19:20:26.201Z"
images: 4
---

# Product features

The Credit Card product supports configuring [statement cycles](/vault-core/5-9/EN/product_library/product_specifications/credit_card/features#1_statement_cycles_and_payment_due_date), [payment due dates](/vault-core/5-9/EN/product_library/product_specifications/credit_card/features#1_2_payment_due_date), and different [transaction types](/vault-core/5-9/EN/product_library/product_specifications/credit_card/features#2_configurable_transaction_types). Banks can also configure specific behaviour for each transaction type (purchases, cash advances, transfers, and balance transfers) and each of their own features. These include:

-   [credit limits](/vault-core/5-9/EN/product_library/product_specifications/credit_card/features#2_1_limits_per_transaction_type)
    
-   [interest rates](/vault-core/5-9/EN/product_library/product_specifications/credit_card/features#2_2_interest_rates_and_accrualcharging_behaviour_per_transaction_type)
    
-   [minimum percentages due for customer payments](/vault-core/5-9/EN/product_library/product_specifications/credit_card/features#2_3_minimum_percentage_due_per_transaction_type)
    
-   [fees](/vault-core/5-9/EN/product_library/product_specifications/credit_card/features#2_4_fees_per_transaction_type)
    
-   [interest-free periods](/vault-core/5-9/EN/product_library/product_specifications/credit_card/features#2_5_interestfree_periods_per_transaction_type)
...
Each transaction type can have its own features, including [credit limits](/vault-core/5-9/EN/product_library/product_specifications/credit_card/features#2_1_limits_per_transaction_type), [interest rates](/vault-core/5-9/EN/product_library/product_specifications/credit_card/features#2_2_interest_rates_and_accrualcharging_behaviour_per_transaction_type) [minimum percentages due for customer payments](/vault-core/5-9/EN/product_library/product_specifications/credit_card/features#2_3_minimum_percentage_due_per_transaction_type), [fees](/vault-core/5-9/EN/product_library/product_specifications/credit_card/features#2_4_fees_per_transaction_type) and [interest-free periods](/vault-core/5-9/EN/product_library/product_specifications/credit_card/features#2_5_interest_free_periods_per_transaction_type).
...
The product rejects any transaction with a value that is in excess of the relevant available limit. For more information, refer to [Transaction type limits](/vault-core/5-9/EN/product_library/product_specifications/credit_card/features#6_3_transaction_type_limits).
...
To see a list of parameters you can use to configure transaction type specific interest rates, see: [Interest parameters](/vault-core/5-9/EN/product_library/product_specifications/credit_card/product_configurability_credit_card#interest_parameters)
...
-   an amount as a percentage value of the transaction amount. per transaction type as described in the section on [transaction type fees](/vault-core/5-9/EN/product_library/product_specifications/credit_card/features#7_4_transaction_type_fees)
...
For more related use cases, see: [Interest-free period - Additional use cases](/vault-core/5-9/EN/product_library/product_specifications/credit_card/appendix#interest_free_period_additional_use_cases)
...
It is possible to configure how the product accrues and applies interest in general and for different transaction types by using [interest parameters](/vault-core/5-9/EN/product_library/product_specifications/credit_card/product_configurability_credit_card#interest_parameters).
...
For more details please refer to [Product Configurability](/vault-core/5-9/EN/product_library/product_specifications/credit_card/product_configurability_credit_card)
...
The product calculates any [accrued interest](/vault-core/5-9/EN/product_library/product_specifications/credit_card/features#3_1_interest_accrual) and due payments according to its standard configuration, any exemptions and additional settings, and:
...
It offers configuration options for components that affect monthly repayments, the [repayment amount](/vault-core/5-9/EN/product_library/product_specifications/credit_card/features#4_1_repayment_amount) and [repayment hierarchy](/vault-core/5-9/EN/product_library/product_specifications/credit_card/features#4_2_repayment_hierarchy), including:
...
Our product enables a bank to configure and modify the following types of limits on a customer account, and configure [fees](/vault-core/5-9/EN/product_library/product_specifications/credit_card/features#7_fees) to charge when an associated limit is breached.
...
Our product charges several different types of fee and allows banks to make changes to the default configuration using the [fee parameters](/vault-core/5-9/EN/product_library/product_specifications/credit_card/product_configurability_credit_card#fee_parameters).
...
Balance transfers are a transaction type; therefore, a bank can choose to [configure the transaction behaviour](/vault-core/5-9/EN/product_library/product_specifications/credit_card/features#2_configurable_transaction_types) and charge customers fees.
...
The product allows a bank to apply repayment holiday at an individual account level by configuring the relevant [event-blocking flag parameters](/vault-core/5-9/EN/product_library/product_specifications/credit_card/product_configurability_credit_card#eventblocking_flag_parameters). Repayment holidays provide the customer a break in monthly payment event-blocking flag parameters commitments.
