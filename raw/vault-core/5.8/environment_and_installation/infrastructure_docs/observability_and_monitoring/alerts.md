---
source_url: "https://vault-portal.thoughtmachine.net/vault-core/5-8/EN/environment_and_installation/infrastructure_docs/observability_and_monitoring/alerts"
title: "Alerts shipped with Vault Core"
scraped_at: "2026-06-17T15:36:51.632Z"
images: 0
---
...
Issue is most likely impacting the availability of critical user-facing or infrastructure service and needs immediate attention. Such alerts must page the oncall engineer
...
Issue, if not addressed immeditately, will likely convert into a critical issue. Such issues should page the oncall engineers
...
Issue is not impacting any critical services but needs to be addressed soon. These issues can be converted into tickets for oncall engineer to look into during office hours
...
Issue has very low impact and can be addressed when the oncaller has no other high severity issues to look into. These issues also should ideally create a ticket for the oncaller
...
## [](#5_8_24_alert_rules_list "Copy link to heading")5.8.24 Alert Rules List
...
The effective time of the last processed Parameter change is {{ $value }} seconds behind the current time, indicating that the Poller is significantly lagging. Consult the Parameter Change Grafana dashboard and investigate the cause of the slowness by checking the latency of DB queries and gRPC calls made by the accounts-change-poller deployment. If this alert has fired on an internal development environment, a wipe (of the params.changes table or the whole environment) may be beneficial if skipping post\_parameter\_change\_hook executions is acceptable. Contact your Thought Machine representative before this approach is taken.
...
Error creating schedule group in {{ $labels.kubernetes\_namespace }}. Check the logs.

 |
| 

SchedulerJobFailedStatusReceived
...
A consumer of scheduler jobs reported a failed outcome status for a job. Republish the job and investigate the cause of the failure.
...
Pod {{ $labels.pod }} - {{ $labels.instance }} is scraped twice in namespace {{ $labels.kubernetes\_namespace }}. This can lead to metrics being counted twice - check service/pod labels and annotations and monitors for Prometheus Vault.
...
## [](#5_8_23_alert_rules_list "Copy link to heading")5.8.23 Alert Rules List
...
## [](#5_8_22_alert_rules_list "Copy link to heading")5.8.22 Alert Rules List
...
## [](#5_8_21_alert_rules_list "Copy link to heading")5.8.21 Alert Rules List
...
## [](#5_8_20_alert_rules_list "Copy link to heading")5.8.20 Alert Rules List
...
## [](#5_8_19_alert_rules_list "Copy link to heading")5.8.19 Alert Rules List
...
## [](#5_8_18_alert_rules_list "Copy link to heading")5.8.18 Alert Rules List
...
## [](#5_8_17_alert_rules_list "Copy link to heading")5.8.17 Alert Rules List
...
LedgerE2ELatencyExceededOneSecond
...
The ledger is processing the 95th percentile of High Priority requests in more than 1s on {{ $labels.kubernetes\_namespace }}
...
## [](#5_8_16_alert_rules_list "Copy link to heading")5.8.16 Alert Rules List
...
## [](#5_8_15_alert_rules_list "Copy link to heading")5.8.15 Alert Rules List
...
## [](#5_8_14_alert_rules_list "Copy link to heading")5.8.14 Alert Rules List
...
## [](#5_8_13_alert_rules_list "Copy link to heading")5.8.13 Alert Rules List
...
## [](#5_8_12_alert_rules_list "Copy link to heading")5.8.12 Alert Rules List
...
## [](#5_8_11_alert_rules_list "Copy link to heading")5.8.11 Alert Rules List
...
## [](#5_8_10_alert_rules_list "Copy link to heading")5.8.10 Alert Rules List
...
## [](#5_8_9_alert_rules_list "Copy link to heading")5.8.9 Alert Rules List
...
## [](#5_8_8_alert_rules_list "Copy link to heading")5.8.8 Alert Rules List
...
## [](#5_8_7_alert_rules_list "Copy link to heading")5.8.7 Alert Rules List
...
## [](#5_8_6_alert_rules_list "Copy link to heading")5.8.6 Alert Rules List
...
## [](#5_8_5_alert_rules_list "Copy link to heading")5.8.5 Alert Rules List
...
## [](#5_8_4_alert_rules_list "Copy link to heading")5.8.4 Alert Rules List
...
## [](#5_8_3_alert_rules_list "Copy link to heading")5.8.3 Alert Rules List
...
## [](#5_8_2_alert_rules_list "Copy link to heading")5.8.2 Alert Rules List
...
## [](#5_8_1_alert_rules_list "Copy link to heading")5.8.1 Alert Rules List
...
## [](#5_8_0_alert_rules_list "Copy link to heading")5.8.0 Alert Rules List
