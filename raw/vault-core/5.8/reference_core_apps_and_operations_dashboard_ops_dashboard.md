---
source_url: "https://vault-portal.thoughtmachine.net/vault-core/5-8/EN/reference/core_apps_and_operations_dashboard/ops_dashboard"
title: "Operations Dashboard"
scraped_at: "2026-06-17T05:35:07.908Z"
images: 1
---

# Operations Dashboard

Welcome to the Vault Core Operations Dashboard documentation. Operations Dashboard is available to clients with a bank-hosted instance of Vault Core and clients with a Vault Core SaaS environment.

## [](#overview "Copy link to heading")Overview

All staff in the bank use the Vault Core banking website to perform tasks. You can assign each employee a role which determines the permissions they have for viewing information and completing actions. You can [customise these roles](/vault-core/5-8/EN/reference/core_apps_and_operations_dashboard/ops_dashboard#permissions_2) to reflect any organisational structure.
...
Learn more about permissions in [Organisation admin → Permissions](/vault-core/5-8/EN/reference/core_apps_and_operations_dashboard/ops_dashboard#permissions_2).
...
The **Customers** screen lets you [search](/vault-core/5-8/EN/reference/core_apps_and_operations_dashboard/ops_dashboard#searching_for_customers) for and view customer records. Operations Dashboard displays each record in the following tabs.
...
You can also [start a customer Workflow](/vault-core/5-8/EN/reference/core_apps_and_operations_dashboard/ops_dashboard#starting_processes_in_vault) from here.
...
The **Audit logs** tab display all requests made to Vault APIs for that customer. Go to the Ledgers menu and click [*Audit logs*](/vault-core/5-8/EN/reference/core_apps_and_operations_dashboard/ops_dashboard#audit_logs) to view audit logs for all customers.
...
While any process is running, the last state in the Process history list presents a button that allows that state’s transition to be [retried](/vault-core/5-8/EN/api/workflows_api#previousworkflowinstanceevent).
...
See also [Payments](/vault-core/5-8/EN/api/payments_hub_api#payment).
...
See also [Posting instruction batches](/vault-core/5-8/EN/api/core_api#posting_instruction_batches).
...
For more information on how Ledger Balances work, see the [Balances](/vault-core/5-8/EN/reference/balances/) documentation.
...
UK specific and requires the [Payments Hub](/vault-core/5-8/EN/reference/payments_hub/)
...
Requires the [Payments Hub](/vault-core/5-8/EN/reference/payments_hub/)
...
For more information on what these parameters mean, see the [balance coordinates](/vault-core/5-8/EN/reference/balances#balances_and_the_accounting_model) documentation.
...
You can only access Audit and Action Log data if your permissions allow you to do so. For more information, see [Operations Dashboard permissions](/vault-core/5-8/EN/reference/core_apps_and_operations_dashboard/ops_dashboard#permissions_2).
...
-   Audit Logs record all requests or responses made to [Vault Core’s APIs](/vault-core/5-8/EN/api/)
...
-   [Audit API](/vault-core/5-8/EN/api/audit_api)
...
See [Using Action and Audit Logs](/vault-core/5-8/EN/reference/core_apps_and_operations_dashboard/ops_dashboard#using_action_and_audit_logs) for a step-by-step guide to performing common tasks using Action Logs.
...
-   This is an optional field set by providing the On-Behalf-Of-Employee-ID header/meta data in the API call that creates the Action Log. For more information, see the [Audit API](/vault-core/5-8/EN/api/audit_api).
...
-   This is an optional field set by providing the On-Behalf-Of-Customer-ID header/meta data in the API call that creates the Action Log. For more information see the [Audit API](/vault-core/5-8/EN/api/audit_api).
    
-   Find a Customer ID by searching in the [Customers screen](/vault-core/5-8/EN/reference/core_apps_and_operations_dashboard/ops_dashboard#customers).
...
The ID of a [customer account](/vault-core/5-8/EN/reference/core_apps_and_operations_dashboard/ops_dashboard#customers).
...
For more information, see [Account migration](/vault-core/5-8/EN/api/core_api#accountmigration).
...
For more information, see [Account update](/vault-core/5-8/EN/api/core_api#accountupdate).
...
For more information, see [EISCD report descriptor](/vault-core/5-8/EN/reference/payments_hub/working-with-the-payments-hub/region-uk#getting_started_with_the_uk_endpoints).
...
For more information, see [Internal accounts](/vault-core/5-8/EN/api/core_api#internal_accounts).
...
For more information, see [Modulus check weight table descriptor](/vault-core/5-8/EN/reference/payments_hub/working-with-the-payments-hub/region-uk#prerequisites).
...
The ID of a payment. For more information, see [Payments](/vault-core/5-8/EN/reference/core_apps_and_operations_dashboard/ops_dashboard#payments).
...
For more information, see [Payments](/vault-core/5-8/EN/reference/core_apps_and_operations_dashboard/ops_dashboard#payments).
...
The ID of a posting instruction batch that is automatically generated in Vault. For more information, see [Posting instruction batches](/vault-core/5-8/EN/reference/postings#posting_instruction_batch).
...
The ID of a product. A product specifies how a customer account behaves and any rules associated with it and is created from a product version. For more information, see [Products](/vault-core/5-8/EN/reference/core_apps_and_operations_dashboard/ops_dashboard#products).
...
For more information, see: Editing access rights for service accounts ([Service accounts](/vault-core/5-8/EN/reference/core_apps_and_operations_dashboard/ops_dashboard#service_accounts_2))
...
For more information, see [Tickets](/vault-core/5-8/EN/api/workflows_api#tickets).
...
For more information, see [UK bank account number](/vault-core/5-8/EN/reference/payments_hub/working-with-the-payments-hub/region-uk/).
...
For more information, see [Workflows](/vault-core/5-8/EN/reference/workflows-tickets/introduction-to-workflows#overview).
...
-   The On-Behalf-Of-Employee-ID or the On-Behalf-Of-Customer-ID headers were set, this displays one or both of the Employee ID or Customer ID values. For more information, see the [Audit API](/vault-core/5-8/EN/api/audit_api).
...
**Customer ID:** A unique identifier for a customer who performed an action. View information about the Customer by searching on the Customer ID in the [Customers screen](/vault-core/5-8/EN/reference/core_apps_and_operations_dashboard/ops_dashboard#Customers). Returns no value if the customer ID was not provided
...
See [Using Action and Audit Logs](/vault-core/5-8/EN/reference/core_apps_and_operations_dashboard/ops_dashboard#using_action_and_audit_logs) for a step-by-step guide to performing common tasks using Audit Logs.
...
See the [API documentation](/vault-core/5-8/EN/api/).
...
A unique identifier for a bank employee.This is an optional field set by providing the On-Behalf-Of-Customer-ID header/meta data in the API call that creates the Action Log. For more information see the [Audit API](/vault-core/5-8/EN/api/audit_api).
...
2.  In the Employee IDs field, enter the:
    ...
    -   Service account ID if the employee may have accessed Vault Core via a third-party tool such as Postman - see Editing access rights for service accounts in [Service accounts](/vault-core/5-8/EN/reference/core_apps_and_operations_dashboard/ops_dashboard#service_accounts_2)
        
    
3.  All requests for that employee are returned. You can add additional filters at this point using the appropriate [filter fields](/vault-core/5-8/EN/reference/core_apps_and_operations_dashboard/ops_dashboard#audit_logs).
    
4.  Click the **Timestamp** link to view the request and response information for each [individual request](/vault-core/5-8/EN/reference/core_apps_and_operations_dashboard/ops_dashboard#audit_logs) made by the employee.
...
7.  Select the **Visibility** level:
    ...
    -   **Operator** level Flag definitions are only visible to users with relevant access rights; for more information, see [The Core API Flags section](/vault-core/5-8/EN/api/core_api#flags)
...
Used to generate API access tokens to enable services to directly access our APIs. For more information, see [Service accounts](/vault-core/5-8/EN/reference/core_apps_and_operations_dashboard/ops_dashboard#accounts)
...
Base permissions (called "Vault permissions" in the [Access Control API](/vault-core/5-8/EN/api/access_control_api/))
...
Custom permissions (called "Data permissions" in the [Access Control API](/vault-core/5-8/EN/api/access_control_api/))

 | 

Can be referenced in policies to enable fine-grained access control to individual tasks and processes.For more information, see [Policies](/vault-core/5-8/EN/reference/policies/legacy-policies/).
...
Note: By default, adding a product initiates processes that create tickets (tasks), which require separate permissions to view. For more information, see Tasks in [Permissions](/vault-core/5-8/EN/reference/core_apps_and_operations_dashboard/ops_dashboard#permissions_2)
...
You can also use custom permissions to restrict visibility of Audit Logs to specific `vault` objects. For more information, see [Audit Log Policies](/vault-core/5-8/EN/reference/policies/legacy-policies#policies).
...
For more information, see the [Calendars](/vault-core/5-8/EN/reference/calendar) documentation.

chat\_bubble

For information about the permissions required for the calendar pages, see [Organisation admin permissions](/vault-core/5-8/EN/reference/core_apps_and_operations_dashboard/ops_dashboard#permissions_2)
...
In the Operations Dashboard when you **delete** a calendar event you are setting the **is\_active** field of the calendar event to **false**. For more information see the Update section of the [Calendar event API](/vault-core/5-8/EN/api/core_api#calendarevent).
...
1.  For the service account you want to regenerate a token for, use the [Create endpoint (POST core-api/v1/service-accounts)](/vault-core/5-8/EN/api/core_api#serviceaccount) to create a replacement token. Ensure that the permissions granted are the same as the service account it is replacing.
    
2.  Update the Vault Core REST API client that is using the old token，so it is using the new token.
    
3.  Once confirmed that the old token is no longer in use, deactivate the old service account with a call to the [Update endpoint (PUT core-api/v1/service-accounts/{service\_account.id})](/vault-core/5-8/EN/api/core_api#serviceaccount), setting the status to `SERVICE_ACCOUNT_STATUS_INACTIVE`.
...
5.  In the **Instantiate from resource** section, use the checkboxes to select/edit any resources (areas of Operations Dashboard) that you want this Workflow Definition to be instantiated from. For more information about these locations, see [Instantiation config](/vault-core/5-8/EN/reference/core_apps_and_operations_dashboard/ops_dashboard#instantiation_config).
...
6.  Edit the locations (resources) that this Workflow Definition version can be instantiated from using the checkboxes. For more information about these locations, see [Instantiation config](/vault-core/5-8/EN/reference/core_apps_and_operations_dashboard/ops_dashboard#instantiation_config).
