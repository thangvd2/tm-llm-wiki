---
source_url: "https://vault-portal.thoughtmachine.net/vault-core/5-8/EN/environment_and_installation/saas/observability_and_api_monitoring/observability_overview"
title: "Observability overview"
scraped_at: "2026-06-16T15:24:17.203Z"
images: 0
---
...
1.  Clients can monitor Vault Core API endpoints for health and availability using tooling of their choice. Refer to the [Vault API Monitoring Guide](/vault-core/5-8/EN/environment_and_installation/saas/observability_and_api_monitoring/api) for more information.
    
2.  Clients can ingest Vault Core metrics into their own monitoring stack through the Observability Metrics Endpoint to provide a centralised view of their ecosystem and use the metrics to build custom dashboards and alerts. Refer to the [Vault SaaS Metrics and Tracing Guide](/vault-core/5-8/EN/environment_and_installation/saas/observability_and_api_monitoring/metrics_and_tracing_guide) for more information. Thought Machine does not ship infrastructure metrics through this endpoint or as part of Vault Core SaaS.
    
3.  Clients can capture and analyse Vault Core business events, such as Balances, Accounts and Schedule execution, through the [Core Streaming API](/vault-core/5-8/EN/environment_and_installation/saas/streaming/streaming_api_documentation#streaming_api_documentation_for_vault_core).
...
SaaS clients access Vault Core API endpoints in the Production environment which can be monitored for service availability and request latency using the client’s choice of tooling. To learn more, see [Vault API Monitoring Guide](/vault-core/5-8/EN/environment_and_installation/saas/observability_and_api_monitoring/api).
...
The API broadcasts events relating to resource creation and change throughout the resource lifecycle. Events are emitted as Kafka messages to a series of client-facing Kafka topics. Clients can subscribe to these topics to perform further operations and analysis. To learn more, see the [Streaming API information](/vault-core/5-8/EN/environment_and_installation/saas/streaming/streaming_api_documentation#streaming_api_documentation_for_vault_core) here and in the [Using the Streaming APIs](/vault-core/5-8/EN/api/overview#using_the_streaming_apis) section.
...
-   [Vault SaaS Metrics and Tracing Guide](/vault-core/5-8/EN/environment_and_installation/saas/observability_and_api_monitoring/metrics_and_tracing_guide)
    
-   [Vault API Monitoring Guide](/vault-core/5-8/EN/environment_and_installation/saas/observability_and_api_monitoring/api)
    
-   [Streaming API information](/vault-core/5-8/EN/environment_and_installation/saas/streaming/streaming_api_documentation#streaming_api_documentation_for_vault_core) and documentation in the [Using the Streaming APIs](/vault-core/5-8/EN/api/overview#using_the_streaming_apis) section