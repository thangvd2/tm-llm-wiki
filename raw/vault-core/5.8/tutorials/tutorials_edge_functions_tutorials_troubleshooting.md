---
source_url: "https://vault-portal.thoughtmachine.net/vault-core/5-8/EN/tutorials/edge_functions_tutorials/troubleshooting"
title: "How to troubleshoot Edge Functions"
scraped_at: "2026-06-16T15:27:50.994Z"
images: 0
---
...
-   [Edge Functions Streaming API reference](/vault-core/5-8/EN/api/edge_functions_api/edge_functions_streaming_api)
    
-   [Monitoring and Disaster Recovery](/vault-core/5-8/EN/reference/edge_functions/overview_and_getting_started/observability_and_disaster_recovery)
...
If you made an execution request and it failed, have you checked if it returned an error code? See [Debugging execution failures](/vault-core/5-8/EN/tutorials/edge_functions_tutorials/troubleshooting#debugging_execution_failures) for advice.
...
2.  Check the [**Execution dashboard**](/vault-core/5-8/EN/reference/edge_functions/overview_and_getting_started/observability_and_disaster_recovery) to monitor the general health of executions.
...
You can refine your request and the result to return only errored executions according to a specific [error code](/vault-core/5-8/EN/tutorials/edge_functions_tutorials/troubleshooting#debugging_execution_failures). You can then analyse the response for the predominant Edge Function IDs and versions, and note the included stack traces.
...
You can find a list of error codes in this guide under [Debugging execution failures](/vault-core/5-8/EN/tutorials/edge_functions_tutorials/troubleshooting#debugging_execution_failures) and the [Edge Functions API reference](/vault-core/5-8/EN/api/edge_functions_api). The guidance also provides information about making requests to Edge Functions endpoints.

### [](#checking_upstream_network_backends "Copy link to heading")Checking Upstream network (backends)

Identify possible causes, such as Smart Contracts (see Performance considerations for [CLv3](/vault-core/5-8/EN/reference/contracts/contracts_api_3xx/performance_considerations/) or [CLv4](/vault-core/5-8/EN/reference/contracts/contracts_api_4xx/performance_considerations/)). If you are unable to identify or resolve the issue, escalate to Thought Machine support for the upstream services that are involved.
