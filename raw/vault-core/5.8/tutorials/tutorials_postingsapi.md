---
source_url: "https://vault-portal.thoughtmachine.net/vault-core/5-8/EN/tutorials/postingsapi"
title: "Postings API"
scraped_at: "2026-06-16T15:27:54.559Z"
images: 0
---
...
-   Registered the Internal Transfer Service integration with the Postings API by creating a [Postings API client](/vault-core/5-8/EN/api/postings_api#creating_postings_api_clients) via the Core API
...
The Internal Transfer Service calls `POST /v1/posting-instruction-batches` on the [synchronous Postings API](/vault-core/5-8/EN/api/core_api#_posting_api_v1_CreatePostingInstructionBatchResponse_CreatePostingInstructionBatch)'s request topic.
...
-   Registered the Inbound Payments Service integration with the Postings API by creating a [Postings API client](/vault-core/5-8/EN/api/postings_api#creating_postings_api_clients) via the Core API
...
The Inbound Payments Service publishes a `pb.CreatePostingInstructionBatchRequest` to the [Postings API](/vault-core/5-8/EN/api/core_api#createpostinginstructionbatchrequest)'s request topic.
...
-   Registered the Outbound Payments Service integration with the Postings API by creating a [Postings API client](/vault-core/5-8/EN/api/core_api#postings_api_clients) via the Core API
...
The Outbound Payments Service publishes a `pb.CreatePostingInstructionBatchRequest` to the [Postings API](/vault-core/5-8/EN/api/core_api#createpostinginstructionbatchrequest)'s request topic.
...
You work for a financial institution that uses Vault Core and want to develop a customer-facing app that lets your customers transfer funds to other customers of your institution. In addition, to [Exercise 1](/vault-core/5-8/EN/tutorials/postingsapi#exercise_1__modelling_an_internal_vault_transfer) , you want to transfer funds through a wash account for accounting purposes. You have:

-   Created a Postings API integration called the Internal Transfer Service
    
-   Registered the Internal Transfer Service integration with the Postings API by creating a [Postings API client](/vault-core/5-8/EN/api/core_api#postings_api_clients) via the Core API
...
The Internal Transfer Service publishes a `pb.CreatePostingInstructionBatchRequest` to the [Postings API](/vault-core/5-8/EN/api/core_api#createpostinginstructionbatchrequest)'s request topic.
...
-   Registered the Payment Service integration with the Postings API by creating a [Postings API client](/vault-core/5-8/EN/api/core_api#postings_api_clients) via the Core API
...
The Payment Service integration publishes a `pb.CreatePostingInstructionBatchRequest` to the [Postings API](/vault-core/5-8/EN/api/core_api#createpostinginstructionbatchrequest)'s request topic.
...
After receiving a successful result from the `OutboundAuthorisation`, the Payment Service integration can later then publish another `pb.CreatePostingInstructionBatchRequest` to the [Postings API](/vault-core/5-8/EN/api/core_api#createpostinginstructionbatchrequest)'s request topic.
