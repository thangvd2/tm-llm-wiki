---
source_url: "https://vault-portal.thoughtmachine.net/vault-core/5-8/EN/environment_and_installation/migrating_to_vault"
title: "Migrating data to Vault"
scraped_at: "2026-06-17T05:31:09.876Z"
images: 0
---
...
-   [BAU Posting API specifications](/vault-core/5-8/EN/api/postings_api#asynchronous_postings_api)
...
No changes to migration documentation directly in response to product improvements in v5.8. The [downloadable information](/vault-core/5-8/EN/environment_and_installation/migrating_to_vault#downloadable_information) below (the Vault Core Migrations Data Dictionary and Tech Deck) have both been updated to support v5.8.
...
](/vault-core/5-8/EN/environment_and_installation/migrating_to_vault/intro)
