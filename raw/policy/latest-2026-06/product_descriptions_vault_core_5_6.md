---
source_url: "https://vault-portal.thoughtmachine.net/policy/latest/EN/product_descriptions/vault_core_5_6"
title: "Vault Core Version 5.6 Product Description"
scraped_at: "2026-06-17T05:17:46.325Z"
images: 0
---

# Vault Core Version 5.6 Product Description

[Download PDF](/policy/latest/EN/resources/vault_core_5_6.pdf)

## [](#overview "Copy link to heading")1\. Overview

This product description describes the following for Vault Core Version 5.6
...
An account that is created on a high-volume eligible Smart Contract. These accounts can capture high volumes of financial movements.
...
#### [](#build_financial_products_that_can_capture_high_volumes_of_financial_movements_optional_add_on "Copy link to heading")3.1.5. Build financial products that can capture high volumes of financial movements (optional add-on)
...
-   Fetch balance observations (only allows for live balance fetching)
...
##### [](#capture_high_volumes_of_financial_movements_on_a_single_account_optional_add_on "Copy link to heading")4.2.1.6. Capture high volumes of financial movements on a single Account (optional add-on)
...
-   Provide parameter change and posting history timelines
...
To view the list of deprecated features, review the deprecation notices in the [technical details of this release on the Documentation Hub](/vault-core/5-6/EN/environment_and_installation/vault_release_information#deprecated_features).