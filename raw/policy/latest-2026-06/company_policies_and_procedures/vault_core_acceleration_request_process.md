---
source_url: "https://vault-portal.thoughtmachine.net/policy/latest/EN/company_policies_and_procedures/vault_core_acceleration_request_process"
title: "Thought Machine Vault Core Acceleration Request Process"
scraped_at: "2026-06-17T15:56:20.913Z"
images: 1
---
...
## [](#owner "Copy link to heading")2\. Owner

This policy is owned and maintained by Thought Machine’s Managing Director of Product and Programme Management.

## [](#the_policy "Copy link to heading")3\. The Policy

### [](#the_vault_core_roadmap "Copy link to heading")3.1. The Vault Core Roadmap
...
### [](#how_clients_can_interact_with_our_roadmap "Copy link to heading")3.2. How clients can interact with our roadmap
...
### [](#acceleration_request_process "Copy link to heading")3.3. Acceleration Request Process

Please see below for a detailed process description and a high level process flow for an acceleration request.

#### [](#stage_1_high_level_review "Copy link to heading")3.3.1. Stage 1: High Level Review
...
#### [](#stage_2_product_design_and_planning "Copy link to heading")3.3.2. Stage 2: Product Design and Planning
...
#### [](#stage_3_delivery "Copy link to heading")3.3.3. Stage 3: Delivery
...
## [](#changes_to_policy "Copy link to heading")4\. Changes to policy
...
## [](#appendix_1 "Copy link to heading")6\. Appendix 1

![acceleration request process](_assets/acceleration_request_process.BTrDqgCc_2i_policyla.webp)