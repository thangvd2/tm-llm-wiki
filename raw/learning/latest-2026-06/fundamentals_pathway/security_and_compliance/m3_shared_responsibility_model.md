---
source_url: "https://vault-portal.thoughtmachine.net/learning/latest/EN/fundamentals_pathway/security_and_compliance/m3_shared_responsibility_model"
title: "Module 3: Shared Responsibility Model"
scraped_at: "2026-06-17T16:00:32.240Z"
images: 3
---
...
## [](#bank_hosted_responsibilities "Copy link to heading")Bank-hosted responsibilities
...
![“An infographic labeled Client illustrates six core areas of responsibility through interconnected](_assets/client_responsibilities.iguYcA3K_6C20R_learning.svg)
...
![“An infographic titled Thought Machine outlines four organizational responsibilities through a series of blue](_assets/tm_responsibilities.BuQzdeC4_Z1NfodJ_learning.svg)
...
## [](#saas_hosted_responsibilities "Copy link to heading")SaaS hosted responsibilities

Here we see the shared responsibilities when using a SaaS model for comparison purposes.

![“This infographic illustrates a shared responsibility model between the Client and Thought Machine for a SaaS environment. The Client is responsible for two primary areas: Identity/access management and Audit logs. In contrast](_assets/saas_responsibility.Df0NHs5Q_ZztCz3_learning.svg)
