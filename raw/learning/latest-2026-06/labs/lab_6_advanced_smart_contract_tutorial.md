---
source_url: "https://vault-portal.thoughtmachine.net/learning/latest/EN/labs/lab_6_advanced_smart_contract_tutorial"
title: "Lab 6 - Advanced Smart Contract Tutorial"
scraped_at: "2026-06-17T15:58:29.378Z"
images: 0
---
...
Also, ensure the **Lab Starter Pack** has been obtained, available [here](/learning/latest/EN/labs#setup), which contains all required python scripts, Postman collection and Smart Contracts in order to begin the exercises in this document. Do refer to the README for any setup instructions.
...
The goal of this hands-on lab is to build upon the foundation of the Basic Smart Contracts introduced in Lab 3 (`basic_deposit.py`). Through a series of exercises, you will implement several advanced smart contract features to fulfill specific requirements. Additionally, you will be responsible for modifying and extending the existing simulation and unit tests to ensure the new logic is thoroughly verified.

## [](#enquiries "Copy link to heading")Enquiries

For any other questions or feedback related to this lab, do reach out to the Enablement Community. Do start the thread with the title \*Advanced Smart Contract Tutorial - <Your Question>

## [](#additional_resources "Copy link to heading")Additional Resources

You can refer to the Product Library for more examples of Smart Contracts used in different business use cases.
