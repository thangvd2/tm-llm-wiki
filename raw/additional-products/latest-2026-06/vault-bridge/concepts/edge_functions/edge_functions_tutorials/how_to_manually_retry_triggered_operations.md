---
source_url: "https://vault-portal.thoughtmachine.net/additional-product-offerings/latest/EN/vault-bridge/concepts/edge_functions/edge_functions_tutorials/how_to_manually_retry_triggered_operations"
title: "How to bulk retry Edge Functions Trigger Operations"
scraped_at: "2026-06-17T15:53:57.185Z"
images: 0
---

# How to bulk retry Edge Functions Trigger Operations

## [](#overview "Copy link to heading")Overview

Edge Function Trigger Operations can sometimes enter a `FAILED` or `FAILED_TRANSIENT` state due to various reasons. Vault Core provides a mechanism to manually request a retry for these operations multiple times, by calling the [BulkRetryEdgeFunctionTriggerOperations](/additional-product-offerings/latest/EN/vault-bridge/api/bridge_api#_bridge_v1_edge_functions_BulkRetryEdgeFunctionTriggerOperationsResponse_BulkRetryEdgeFunctionTriggerOperations) endpoint.
...
2.  **Operation ID**: You need the unique identifier (`id`) of the Trigger Operation to be retried. Use the [ListEdgeFunctionTriggerOperations](/additional-product-offerings/latest/EN/vault-bridge/api/bridge_api#_bridge_v1_edge_functions_ListEdgeFunctionTriggerOperationsResponse_ListEdgeFunctionTriggerOperations) endpoint to fetch its `id`.
...
Make an HTTP POST request to the following [BulkRetryEdgeFunctionTriggerOperations](/additional-product-offerings/latest/EN/vault-bridge/api/bridge_api#_bridge_v1_edge_functions_BulkRetryEdgeFunctionTriggerOperationsResponse_BulkRetryEdgeFunctionTriggerOperations) endpoint:
