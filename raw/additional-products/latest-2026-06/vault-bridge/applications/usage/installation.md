---
source_url: "https://vault-portal.thoughtmachine.net/additional-product-offerings/latest/EN/vault-bridge/applications/usage/installation"
title: "Installation"
scraped_at: "2026-06-17T15:55:35.800Z"
images: 0
---
...
Assuming you have Vault Core External System added, you will need to add some Credentials, and an Integration Configuration named `bridge-vault-usage-monitor-app` with specific values for Usage Monitor to work.

## [](#requirements "Copy link to heading")Requirements

Usage Monitor is only available on Vault Bridge against Vault Core with version 5.9 or above.
...
`Vault Version: View` is a required permission for all roles for access to the Usage Monitor App.
...
An Integration Config named `bridge-vault-usage-monitor-app` must be created.
