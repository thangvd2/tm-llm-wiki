---
source_url: "https://vault-portal.thoughtmachine.net/additional-product-offerings/latest/EN/vault-bridge/concepts/edge_functions/allowed_imports"
title: "Allowed Python imports in Edge Functions"
scraped_at: "2026-06-17T05:15:28.254Z"
images: 0
---
...
`Annotated`, `Any`, `AnyStr`, `Callable`, `ClassVar`, `Concatenate`, `Final`, `Generic`, `Literal`, `NamedTuple`, `NewType`, `NoReturn`, `ParamSpec`, `ParamSpecArgs`, `ParamSpecKwargs`, `Protocol`, `SupportsAbs`, `SupportsBytes`, `SupportsComplex`, `SupportsFloat`, `SupportsIndex`, `SupportsInt`, `SupportsRound`, `TYPE_CHECKING`, `Tuple`, `TypeAlias`, `TypeGuard`, `TypeVar`, `TypedDict`, `cast`, `final`, `is_typeddict`, `no_type_check`, `no_type_check_decorator`, `overload`, `runtime_checkable`
