...
scraped_at: "2026-04-20T18:20:02.708Z"
images: 0
---
...
In version 4.0+, any imported Contract Module will be available throughout the contract. You cannot access Contract Modules via the Supervisor Contracts `vault` object or the `vault.supervisees` dictionary.
...
If the [Vault Object](/vault-core/5-8/EN/reference/contracts/contracts_api_4xx/smart_contracts_api_reference4xx/vault/) is required by a Contract Module function, it must be passed in as an argument just as it would be for a helper function in the Smart Contract itself.