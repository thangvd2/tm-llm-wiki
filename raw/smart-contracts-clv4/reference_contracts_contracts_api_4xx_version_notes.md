...
scraped_at: "2026-04-20T18:20:06.629Z"
images: 0
---
...
-   All hooks now take two arguments: [`vault`](/vault-core/5-8/EN/reference/contracts/contracts_api_4xx/smart_contracts_api_reference4xx/vault/) , which is the relevant Vault object, and [`hook_arguments`](/vault-core/5-8/EN/reference/contracts/contracts_api_4xx/smart_contracts_api_reference4xx/hooks/), which is the hook-specific Arguments class instance. Note that `hook_arguments` has an `effective_datetime` attribute for all hooks.
...
-   Some `vault` attributes, methods or method attributes have been removed as their return data can be retrieved in a different way, as follows:
    ...
    -   The Smart Contracts [`vault` object](/vault-core/5-8/EN/reference/contracts/contracts_api_4xx/smart_contracts_api_reference4xx/vault#attributes) now has `account_id`, `tside` and `events_timezone` attributes.
